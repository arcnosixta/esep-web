...
const _slides = [
  ...
  _SlideData(
    ...
    description:
        ...
        'оценку. Загруженные документы он учтёт автоматически.',
    color: Color(0xFF7C4DFF),
  ),
  _SlideData(
    icon: Icons.folder_copy_rounded,
    title: 'Документы = точный анализ',
    description:
        'Загрузите во вкладку «Документы» страховку, план или фото объекта '
        '— ИИ учтёт их при оценке и реже будет задавать вопросы. '
        'Оплатите заявку — получите официальный подписанный отчёт.',
